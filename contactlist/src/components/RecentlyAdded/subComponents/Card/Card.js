        ...
        if (state.showCheckBox === true) {
            component = (
                <div className="row py-2">
                    ...
                    <div className="col-2 text-left small">{state.Name}</div>
                    <div className="col-2 text-left small">{'+91' + state.number}</div>
                    <div className="col-3 text-center small">{state.email}</div>
